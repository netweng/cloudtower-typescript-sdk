...
class Api extends HttpClient {
    constructor() {
        ...
        this.mountUsbDevice = {
            updateUsbDevice: (data, params = {}) => this.request(Object.assign({ path: `/mount-usb-device`, method: "POST", body: data, type: ContentType.Json, format: "json" }, params)),
        };
        ...
        this.force = {
            ...
            forceShutDownVm: (data, params = {}) => this.request(Object.assign({ path: `/force/shut-down-vm`, method: "POST", body: data, type: ContentType.Json, format: "json" }, params)),
        };
        this.shutDownVm = {
            shutDownVm: (data, params = {}) => this.request(Object.assign({ path: `/shut-down-vm`, method: "POST", body: data, type: ContentType.Json, format: "json" }, params)),
        };
        this.suspendVm = {
